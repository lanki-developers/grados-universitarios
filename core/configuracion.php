<?php
	...
	*/
	...
	$BaseDatos='bd_grados';   // Path completo cuando se trata de sqlite2, ej: '/path/to/database.sdb'
	$UsuarioBD='user_grados';
	$PasswordBD='ab9%dMM&jdB7UedM';
	...
	*/
	...
	$LlaveDePaso='D79UEXLEOD';  // Valor unico para firmar los usuarios del aplicativo.  No debe ser cambiado despues de puesto en marcha a menos que se haga un update manual el usuario que no coincida con la llave no podra ingresar.
	$ModoDepuracion=0;
	$PermitirReporteBugs=0;
	$DepuracionSQL=0;
